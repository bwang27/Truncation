...
##download gtf format gene annotation file:
for geno in hg19; do #rheMac10 rn6 canFam3
 echo __________ $geno __________
 dir=$pipeline_root/ReferenceDB/ucsc/geneGFT/$geno
 mkdir -p $dir
 cd $dir
 wget https://hgdownload.soe.ucsc.edu/goldenPath/$geno/bigZips/genes/$geno.ncbiRefSeq.gtf.gz
 gunzip *gz
done
